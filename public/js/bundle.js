    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 48, 12, 1773);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);

    			if (!mounted) {
    				dispose = listen_dev(a, "click", stop_propagation(/*click_handler_2*/ ctx[15]), false, false, true);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 51, 12, 1943);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);

    			if (!mounted) {
    				dispose = listen_dev(a, "click", stop_propagation(/*click_handler_3*/ ctx[16]), false, false, true);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(h2, "click", stop_propagation(/*click_handler*/ ctx[10]), false, false, true),
    					listen_dev(a, "click", stop_propagation(/*click_handler_1*/ ctx[14]), false, false, true)
    				];
