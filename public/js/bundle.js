...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "toolbar__link toolbar__link_watch svelte-18av4br");
    			attr_dev(span, "title", "Video");
    			add_location(span, file$4, 20, 9, 588);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*video*/ ctx[4] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			t9 = text("Download");
    			attr_dev(span0, "class", "app-id svelte-18av4br");
    			add_location(span0, file$4, 13, 3, 269);
    			attr_dev(h3, "class", "svelte-18av4br");
    			add_location(h3, file$4, 15, 6, 334);
    			attr_dev(p, "class", "svelte-18av4br");
    			add_location(p, file$4, 16, 6, 357);
    			attr_dev(span1, "class", "toolbar__link toolbar__link_try svelte-18av4br");
    			attr_dev(span1, "title", "Run demo");
    			add_location(span1, file$4, 18, 9, 408);
    			attr_dev(a, "class", "toolbar__link toolbar__link_download svelte-18av4br");
    			attr_dev(a, "title", "Download");
    			attr_dev(a, "href", a_href_value = "/apps/" + /*id*/ ctx[0] + ".zip");
    			add_location(a, file$4, 22, 9, 765);
    			attr_dev(div0, "class", "toolbar svelte-18av4br");
    			add_location(div0, file$4, 17, 6, 377);
    			attr_dev(div1, "class", "app-info svelte-18av4br");
    			add_location(div1, file$4, 14, 3, 305);
    			attr_dev(div2, "class", "app-details svelte-18av4br");
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => dispatch("showdemo", { id, title, video, help, tab: "app" });
    	const click_handler_1 = () => dispatch("showdemo", { id, title, video, help, tab: "video" });
    	...
    	return [id, title, info, help, video, dispatch, click_handler, click_handler_1];
    }
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file$1, 38, 12, 1181);
    			attr_dev(div, "class", "content-container svelte-1ou18wd");
    			toggle_class(div, "hidden", /*selected*/ ctx[4] != /*sVideo*/ ctx[6]);
    			add_location(div, file$1, 37, 9, 1086);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "#2");
    			attr_dev(a, "role", "tab");
    			attr_dev(a, "class", "svelte-1ou18wd");
    			toggle_class(a, "selected", /*selected*/ ctx[4] == /*sVideo*/ ctx[6]);
    			add_location(a, file$1, 49, 12, 1827);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);

    			if (!mounted) {
    				dispose = listen_dev(a, "click", stop_propagation(/*click_handler_2*/ ctx[16]), false, false, true);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 52, 12, 1997);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);

    			if (!mounted) {
    				dispose = listen_dev(a, "click", stop_propagation(/*click_handler_3*/ ctx[17]), false, false, true);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1ou18wd");
    			add_location(h2, file$1, 30, 9, 771);
    			attr_dev(header, "class", "modal-header svelte-1ou18wd");
    			add_location(header, file$1, 29, 6, 732);
    			attr_dev(div0, "class", "content-container svelte-1ou18wd");
    			toggle_class(div0, "hidden", /*selected*/ ctx[4] != /*sApp*/ ctx[5]);
    			add_location(div0, file$1, 33, 9, 931);
    			attr_dev(div1, "class", "content-container helptext svelte-1ou18wd");
    			toggle_class(div1, "hidden", /*selected*/ ctx[4] != /*sHelp*/ ctx[7]);
    			add_location(div1, file$1, 41, 9, 1438);
    			attr_dev(section, "class", "modal-content svelte-1ou18wd");
    			add_location(section, file$1, 32, 6, 890);
    			attr_dev(a, "href", "#1");
    			attr_dev(a, "role", "tab");
    			attr_dev(a, "class", "svelte-1ou18wd");
    			toggle_class(a, "selected", /*selected*/ ctx[4] == /*sApp*/ ctx[5]);
    			add_location(a, file$1, 47, 12, 1680);
    			attr_dev(nav, "class", "tablist svelte-1ou18wd");
    			attr_dev(nav, "role", "tablist");
    			add_location(nav, file$1, 46, 9, 1631);
    			attr_dev(footer, "class", "modal-footer svelte-1ou18wd");
    			add_location(footer, file$1, 45, 6, 1592);
    			attr_dev(article, "class", "modal svelte-1ou18wd");
    			add_location(article, file$1, 28, 3, 655);
    			attr_dev(div2, "class", "backstage svelte-1ou18wd");
    			add_location(div2, file$1, 27, 0, 612);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(h2, "click", stop_propagation(/*click_handler*/ ctx[11]), false, false, true),
    					listen_dev(a, "click", stop_propagation(/*click_handler_1*/ ctx[15]), false, false, true)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(4, selected = tab === "video" ? sVideo : sApp);
    	});
