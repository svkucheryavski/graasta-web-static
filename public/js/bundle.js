...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 16, 9, 415);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 9, 3, 161);
    			attr_dev(h3, "class", "svelte-1wsuemj");
    			add_location(h3, file$4, 11, 6, 226);
    			attr_dev(p, "class", "svelte-1wsuemj");
    			add_location(p, file$4, 12, 6, 249);
    			...
    			add_location(a0, file$4, 14, 9, 300);
    			...
    			add_location(a1, file$4, 18, 9, 527);
    			attr_dev(div0, "class", "toolbar svelte-1wsuemj");
    			add_location(div0, file$4, 13, 6, 269);
    			attr_dev(div1, "class", "app-info svelte-1wsuemj");
    			add_location(div1, file$4, 10, 3, 197);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ id, title, info, help, video });
    	...
    	return [id, title, info, video, help];
    }
    ...
    class AppDetails extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*help*/ ctx[4] === undefined && !('help' in props)) {
    			console.warn("<AppDetails> was created without expected prop 'help'");
    		}
    	}
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 48, 12, 1672);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 51, 12, 1799);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['id', 'info', 'title', 'video', 'help', 'tab'];
