...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			t = text("Video-lesson");
    			attr_dev(a, "title", "Link to YouTube video");
    			attr_dev(a, "href", /*video*/ ctx[3]);
    			attr_dev(a, "class", "svelte-flsgey");
    			add_location(a, file$4, 19, 20, 536);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*video*/ ctx[3] && create_if_block$1(ctx);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [id, title, info, video, dispatch, click_handler];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-3bclbo");
    			add_location(h2, file$1, 14, 9, 436);
    			attr_dev(header, "class", "modal-header svelte-3bclbo");
    			add_location(header, file$1, 13, 6, 397);
    			attr_dev(div0, "class", "app-container svelte-3bclbo");
    			add_location(div0, file$1, 17, 9, 522);
    			attr_dev(section, "class", "modal-content svelte-3bclbo");
    			add_location(section, file$1, 16, 6, 481);
    			attr_dev(article, "class", "modal svelte-3bclbo");
    			add_location(article, file$1, 12, 3, 336);
    			attr_dev(div1, "class", "backstage svelte-3bclbo");
